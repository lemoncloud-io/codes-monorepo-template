...
type Base64Data = { data: string; mimeType: string };
const fileToBase64 = (file: File): Promise<Base64Data> => {
...
export const generateFigureImage = async (selectedFile: File): Promise<string | null> => {
    try {
